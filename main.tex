...
\section{Introduction}
	...
	Robot Motion Planning is the problem of moving a robot from one state to another in some environment. States can simply positions, or they can be high-dimensional configurations. They can also include dynamic information, such as a specific velocity or acceleration.	Motion planning is required in almost every robotics tasks that exists. Unfortunately, this problem is made difficult by several things: 
	...
	Real-time motion planning is the problem of performing motion planning on-line in order to react to a dynamic environment. There are no 
