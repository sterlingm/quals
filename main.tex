...
The goal of the \emph{learning} phase is to build the C-space approximation. A basic version of the algorithm is summarized below.
...
The goal is to build an undirected graph containing $N$ nodes. Potential nodes are randomly sampled and checked for collision. If collision exists, the sampled is thrown away and the algorithm samples again. 
